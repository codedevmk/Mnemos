...
namespace mnemos::apps::player::adapters::irem_m85 {
    ...
    class irem_m85_adapter;

    [[nodiscard]] runtime::save_target build_save_target(manifests::irem_m85::m85_system& sys);
    [[nodiscard]] runtime::save_target build_save_target(irem_m85_adapter& adapter);

    class irem_m85_adapter final : public frontend_sdk::player_system {
      public:
        explicit irem_m85_adapter(std::vector<std::uint8_t> rom, std::string display_name = {},
        ...
        [[nodiscard]] frontend_sdk::video_region region() const noexcept override {
            return {.frames_per_second_x1000 = manifests::irem_m85::frame_rate_x1000,
        ...
        [[nodiscard]] manifests::irem_m85::m85_system& machine() noexcept { return *sys_; }
      ...
      private:
        friend runtime::save_target build_save_target(irem_m85_adapter& adapter);
        ...
        std::unique_ptr<manifests::irem_m85::m85_system> sys_;
