...
namespace mnemos::apps::player::adapters::irem_m82 {
    ...
    class irem_m82_adapter;

    [[nodiscard]] runtime::save_target build_save_target(manifests::irem_m82::m82_system& sys);
    [[nodiscard]] runtime::save_target build_save_target(irem_m82_adapter& adapter);

    class irem_m82_adapter final : public frontend_sdk::player_system {
      public:
        explicit irem_m82_adapter(std::vector<std::uint8_t> rom, std::string display_name = {},
        ...
        [[nodiscard]] manifests::irem_m82::m82_system& machine() noexcept { return *sys_; }
        [[nodiscard]] const std::string& set_name() const noexcept { return loaded_set_name_; }

      private:
        friend runtime::save_target build_save_target(irem_m82_adapter& adapter);
        ...
        std::unique_ptr<manifests::irem_m82::m82_system> sys_;
