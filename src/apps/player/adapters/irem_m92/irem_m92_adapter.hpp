...
namespace mnemos::apps::player::adapters::irem_m92 {
    ...
    class irem_m92_adapter;

    [[nodiscard]] runtime::save_target build_save_target(manifests::irem_m92::m92_system& sys);
    [[nodiscard]] runtime::save_target build_save_target(irem_m92_adapter& adapter);

    class irem_m92_adapter final : public frontend_sdk::player_system {
      public:
        ...
        [[nodiscard]] manifests::irem_m92::m92_system& machine() noexcept { return *sys_; }
        [[nodiscard]] const std::string& set_name() const noexcept { return loaded_set_name_; }

      private:
        friend runtime::save_target build_save_target(irem_m92_adapter& adapter);
        ...
        std::unique_ptr<manifests::irem_m92::m92_system> sys_;
