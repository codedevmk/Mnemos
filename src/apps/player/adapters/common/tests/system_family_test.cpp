...
TEST_CASE("system_family: every registry id maps to its family") {
    ...
    CHECK(family_from_name("irem_m10") == system_family::irem_m10);
    CHECK(family_from_name("m10") == system_family::irem_m10);
    ...
    CHECK(family_from_name("irem_redalert") == system_family::irem_redalert);
    CHECK(family_from_name("redalert") == system_family::irem_redalert);
    ...
    CHECK(family_from_name("irem_m78") == system_family::irem_m78);
    CHECK(family_from_name("m78") == system_family::irem_m78);
    ...
    CHECK(family_from_name("irem_m90") == system_family::irem_m90);
    CHECK(family_from_name("m90") == system_family::irem_m90);
    CHECK(family_from_name("irem_m92") == system_family::irem_m92);
    CHECK(family_from_name("m92") == system_family::irem_m92);
    CHECK(family_from_name("irem_m102") == system_family::irem_m102);
    CHECK(family_from_name("m102") == system_family::irem_m102);
    CHECK(family_from_name("irem_m107") == system_family::irem_m107);
    CHECK(family_from_name("m107") == system_family::irem_m107);
    CHECK(family_from_name("irem_m119") == system_family::irem_m119);
    CHECK(family_from_name("m119") == system_family::irem_m119);
    ...
    CHECK(family_from_name("amiga500+") == system_family::amiga500_plus);
    CHECK(family_from_name("a500plus") == system_family::amiga500_plus);
...
TEST_CASE("system_family: family_from_name and family_id round-trip") {
    for (const auto family :
         {system_family::genesis,       system_family::sms,      system_family::gg,
          ...
          system_family::irem_m10,      system_family::irem_m14, system_family::irem_m15,
          system_family::irem_m27,      system_family::irem_m47, system_family::irem_m52,
          system_family::irem_m57,      system_family::irem_m58, system_family::irem_m62,
          system_family::irem_m63,      system_family::irem_travrusa,
          system_family::irem_redalert, system_family::irem_m72, system_family::irem_m75,
          system_family::irem_m78,      system_family::irem_m81, system_family::irem_m82,
          system_family::irem_m84,      system_family::irem_m85, system_family::irem_m90,
          system_family::irem_m92,      system_family::irem_m102, system_family::irem_m107,
...
TEST_CASE("system_family: family_label returns the expected display name") {
    ...
    CHECK(std::string{family_label(system_family::irem_redalert)} == "Irem Red Alert");
    CHECK(std::string{family_label(system_family::irem_m72)} == "Irem M72");
    CHECK(std::string{family_label(system_family::irem_m75)} == "Irem M75");
    CHECK(std::string{family_label(system_family::irem_m78)} == "Irem M78");
    ...
    CHECK(std::string{family_label(system_family::irem_m90)} == "Irem M90");
    CHECK(std::string{family_label(system_family::irem_m92)} == "Irem M92");
    CHECK(std::string{family_label(system_family::irem_m102)} == "Irem M102");
    CHECK(std::string{family_label(system_family::irem_m107)} == "Irem M107");
    CHECK(std::string{family_label(system_family::irem_m119)} == "Irem M119");
