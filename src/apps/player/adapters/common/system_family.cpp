...
namespace mnemos::apps::player::adapters {
    ...
    std::optional<system_family> family_from_name(const std::string& name) noexcept {
        ...
        if (id == "taito_gnet" || id == "gnet") {
            return system_family::taito_gnet;
        }
        if (id == "cps1") {
        ...
        if (id == "amiga1000" || id == "a1000") {
            return system_family::amiga1000;
        }
        ...
        if (id == "amiga600" || id == "a600") {
            return system_family::amiga600;
        }
        if (id == "amiga2000" || id == "a2000") {
            return system_family::amiga2000;
        }
        return std::nullopt;
    }
    ...
    const char* family_names() noexcept {
        return "genesis, sms, gg, c64, segacd, sega32x, irem_m10, irem_m14, irem_m15, irem_m27, "
               ...
               "msx2, amiga1000, amiga500, amiga500plus, amiga600, amiga2000";
    }
