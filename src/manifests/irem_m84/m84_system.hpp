...
namespace mnemos::manifests::irem_m84 {
    ...
    // First executable M84 slice: Hammerin' Harry M84 clone sets currently use
    // the M81-compatible V30/Z80/YM2151/DAC board core while preserving an M84
    // manifest/save identity and M84-owned media routing.
    struct m84_system final {
        irem_m81::m81_system board;
        m84_board_params params;
        ...
        explicit m84_system(common::rom_set_image image, m84_board_params board_params = {});
    ...
    [[nodiscard]] std::unique_ptr<m84_system> assemble_m84(common::rom_set_image image,
