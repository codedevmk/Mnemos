...
namespace mnemos::manifests::genesis {
    ...
    struct genesis_system final {
        ...
        // Active-high pad state: bit 0..7 = Up, Down, Left, Right, A, B, C, Start.
        // read_pad_port() converts to the active-low wire format; pad_th[]
        // latches the TH select bit per port.
        ...
        // Sega 3-button protocol: TH=1 selects the U/D/L/R/B/C bank, TH=0
        // selects U/D/-/-/A/Start (the locked-low L/R lets games detect the pad).
