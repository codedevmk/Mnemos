...
namespace mnemos::manifests::capcom_cps1 {
    namespace {
        ...
        constexpr std::array<gfx_bank_range, 1> ranges_cp1b1f{{
            {all4, 0x0000U, 0xFFFFU, 0U},
        }};
        constexpr std::array<gfx_bank_range, 3> ranges_tn2292{{
            {all4, 0x0000U, 0x7FFFU, 0U},
            {all4, 0x8000U, 0xFFFFU, 1U},
            {all4, 0x10000U, 0x17FFFU, 2U},
        }};
        constexpr std::array<gfx_bank_range, 5> ranges_dam63b{{
            {spr, 0x0000U, 0x1FFFU, 0U},
            {sc1, 0x2000U, 0x2FFFU, 0U},
            {sc2, 0x4000U, 0x7FFFU, 0U},
            {sc3, 0x0000U, 0x1FFFFU, 1U},
            {spr, 0x2000U, 0x3FFFU, 1U},
        }};
        ...
        constexpr std::array<gfx_bank_range, 4> ranges_rcm63b{{
            {all4, 0x0000U, 0x7FFFU, 0U},
            {all4, 0x8000U, 0xFFFFU, 1U},
            {all4, 0x10000U, 0x17FFFU, 2U},
            {all4, 0x18000U, 0x1FFFFU, 3U},
        }};
        constexpr std::array<gfx_bank_range, 5> ranges_tk22b{{
            {spr, 0x0000U, 0x3FFFU, 0U},
            {spr, 0x4000U, 0x5FFFU, 1U},
            {sc1, 0x6000U, 0x7FFFU, 1U},
            {sc3, 0x0000U, 0x3FFFU, 2U},
            {sc2, 0x4000U, 0x7FFFU, 3U},
        }};
        constexpr std::array<gfx_bank_range, 2> ranges_va22b{{
            {all4, 0x0000U, 0x3FFFU, 0U},
            {all4, 0x4000U, 0x7FFFU, 1U},
        }};
        ...
        constexpr std::array<cps_b_profile, 43> board_db{{
            ...
            // profile 33 (cps_b 21_cp1b1f, mapper cp1b1f)
            cps_b_profile{
                .legacy = false,
                .layer_control_offset = 0x26U,
                .priority_offset = {0x28U, 0x2AU, 0x2CU, 0x2EU},
                ...
                .mult_offset = {0x00U, 0x02U, 0x04U, 0x06U},
                .cps_b_eeprom = true,
                .mapper = {.bank_size = {0x10000U, 0U, 0U, 0U}, .ranges = ranges_cp1b1f},
            },
            // profile 35 (cps_b 21_tn2292, mapper tn2292)
            cps_b_profile{
                .legacy = false,
                .layer_control_offset = 0x26U,
                .priority_offset = {0x28U, 0x2AU, 0x2CU, 0x2EU},
                ...
                .id_value = 0x0000U,
                .mult_offset = {0x00U, 0x02U, 0x04U, 0x06U},
                .mapper = {.bank_size = {0x8000U, 0x8000U, 0x8000U, 0U}, .ranges = ranges_tn2292},
            },
            // profile 36 (cps_b 21_dam63b, mapper dam63b)
            cps_b_profile{
                .legacy = false,
                .layer_control_offset = 0x26U,
                .priority_offset = {0x28U, 0x2AU, 0x2CU, 0x2EU},
                ...
                .id_value = 0x0000U,
                .mult_offset = {0x00U, 0x02U, 0x04U, 0x06U},
                .mapper = {.bank_size = {0x8000U, 0x8000U, 0U, 0U}, .ranges = ranges_dam63b},
            },
            // profile 40 (cps_b qs1_tk263b, mapper tk263b)
            cps_b_profile{
                .legacy = false,
                .layer_control_offset = 0x22U,
                .priority_offset = {0x24U, 0x26U, 0x28U, 0x2AU},
                .palette_control_offset = 0x2CU,
                .layer_enable_mask = {0x10U, 0x08U, 0x04U, 0U, 0U},
                .id = 40U,
                .id_offset = reg_none,
                .id_value = 0x0000U,
                .mult_offset = {reg_none, reg_none, reg_none, reg_none},
            ...
            // profile 41 (cps_b qs4_mb63b, mapper mb63b)
            cps_b_profile{
                .legacy = false,
                .layer_control_offset = 0x16U,
                .priority_offset = {0x00U, 0x02U, 0x28U, 0x2AU},
                .palette_control_offset = 0x2CU,
                .layer_enable_mask = {0x04U, 0x08U, 0x10U, 0U, 0U},
                .id = 41U,
                .id_offset = 0x2EU,
                .id_value = 0x0C01U,
                .mult_offset = {reg_none, reg_none, reg_none, reg_none},
                .mapper = {.bank_size = {0x8000U, 0x8000U, 0x8000U, 0U}, .ranges = ranges_mb63b},
            },
            // profile 42 (cps_b qs5_mb63b, mapper mb63b)
            cps_b_profile{
                .legacy = false,
                .layer_control_offset = 0x2AU,
                .priority_offset = {0x2CU, 0x2EU, 0x30U, 0x32U},
                .palette_control_offset = 0x1CU,
                .layer_enable_mask = {0x04U, 0x08U, 0x10U, 0U, 0U},
                .id = 42U,
                .id_offset = 0x1EU,
            ...
            // profile 43 (cps_b b11_s9263b, mapper s9263b)
            cps_b_profile{
                .legacy = false,
                .layer_control_offset = 0x26U,
                .priority_offset = {0x28U, 0x2AU, 0x2CU, 0x2EU},
            ...
            // profile 44 (cps_b def_rcm63b, mapper rcm63b)
            cps_b_profile{
                .legacy = false,
                .layer_control_offset = 0x26U,
                .priority_offset = {0x28U, 0x2AU, 0x2CU, 0x2EU},
            ...
            // profile 52 (cps_b b02_tk22b, mapper tk22b)
            cps_b_profile{
                .legacy = false,
                .layer_control_offset = 0x2CU,
                .priority_offset = {0x2AU, 0x28U, 0x26U, 0x24U},
                ...
                .id_value = 0x0002U,
                .mult_offset = {reg_none, reg_none, reg_none, reg_none},
                .mapper = {.bank_size = {0x4000U, 0x4000U, 0x4000U, 0x4000U},
                           .ranges = ranges_tk22b},
            },
            // profile 53 (cps_b b18_s9263b, mapper s9263b)
            cps_b_profile{
                .legacy = false,
                .layer_control_offset = 0x1CU,
                .priority_offset = {0x1AU, 0x18U, 0x16U, 0x14U},
                .palette_control_offset = 0x12U,
                .layer_enable_mask = {0x10U, 0x08U, 0x02U, 0U, 0U},
                .id = 53U,
                .id_offset = 0x10U,
                .id_value = 0x0408U,
                .mult_offset = {reg_none, reg_none, reg_none, reg_none},
                .cps_b_base = 0x8001C0U,
                .mapper = {.bank_size = {0x8000U, 0x8000U, 0x8000U, 0U}, .ranges = ranges_s9263b},
            },
            // profile 54 (cps_b bt5_va22b, mapper va22b)
            cps_b_profile{
                .legacy = false,
                .layer_control_offset = 0x20U,
                .priority_offset = {0x2EU, 0x2CU, 0x2AU, 0x28U},
                .palette_control_offset = 0x30U,
                .layer_enable_mask = {0x20U, 0x04U, 0x02U, 0U, 0U},
                .id = 54U,
                .id_offset = reg_none,
                .id_value = 0x0000U,
                .mult_offset = {0x0EU, 0x0CU, 0x0AU, 0x08U},
                .mapper = {.bank_size = {0x4000U, 0x4000U, 0U, 0U}, .ranges = ranges_va22b},
            },
