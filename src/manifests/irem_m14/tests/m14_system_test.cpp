...
TEST_CASE("Irem M14 system runs the first-pass 8080-compatible memory map", "[irem_m14]") {
    namespace M14 = mnemos::manifests::irem_m14;
...
TEST_CASE("Irem M14 video output is GFX-ROM and RAM driven", "[irem_m14]") {
    ...
    M14::m14_video first;
    first.compose(video_ram, color_ram, gfx, program, false, "m14_ptrmj_8080_surrogate");
    M14::m14_video second;
    second.compose(video_ram, color_ram, gfx, program, false, "m14_ptrmj_8080_surrogate");
    ...
    flipped.compose(video_ram, color_ram, gfx, program, true, "m14_ptrmj_8080_surrogate");
