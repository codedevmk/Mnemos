...
// shell for Vigilante and Meikyu Jima / Kickle Cubicle; authentic tile/sprite
// priority remains a parity gap.
...
namespace mnemos::manifests::irem_m75 {
    ...
    inline constexpr std::size_t kikcubic_proms_size = 0x000140U;
