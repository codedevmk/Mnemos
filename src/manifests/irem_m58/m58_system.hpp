...
namespace mnemos::manifests::irem_m58 {
    ...
    struct m58_board_params final {
        std::string_view rom_layout{"ten_yard_fight"};
        std::uint8_t dsw1_default{tenyard_dsw1_default};
        std::uint8_t dsw2_default{tenyard_dsw2_default};
    };

    [[nodiscard]] m58_board_params board_params_for(std::string_view set_name) noexcept;

    class m58_video final : public chips::ivideo {
      public:
        m58_video();
    ...
    struct m58_system final {
        ...
        std::uint8_t dsw1{tenyard_dsw1_default};
        std::uint8_t dsw2{tenyard_dsw2_default};
        ...
        explicit m58_system(common::rom_set_image image, m58_board_params board_params = {});
    ...
    [[nodiscard]] std::unique_ptr<m58_system> assemble_m58(common::rom_set_image image,
