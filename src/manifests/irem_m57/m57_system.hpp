...
namespace mnemos::manifests::irem_m57 {
    ...
    inline constexpr std::uint32_t m57_system_state_version = 1U;

    inline constexpr std::size_t main_rom_size = 0x10000U;
    inline constexpr std::size_t gfx_rom_size = 0x4000U;
    ...
    inline constexpr std::uint8_t newtangl_dip_default = 0xFFU;
    ...
    struct m57_board_params final {
        std::uint32_t cpu_clock_hz{mnemos::manifests::irem_m57::cpu_clock_hz};
        std::string_view rom_layout{"m57_newtangl_z80_raw_media"};
        std::uint8_t dip_default{newtangl_dip_default};
    };

    [[nodiscard]] m57_board_params board_params_for(std::string_view set_name) noexcept;

    struct m57_system;

    class m57_cpu_bus final : public chips::ibus {
      public:
        void attach(m57_system& system) noexcept { system_ = &system; }
    ...
    class m57_video final : public chips::ivideo {
      public:
        m57_video();
    ...
    struct m57_system final {
        ...
        std::uint8_t dip_switches{newtangl_dip_default};
        ...
        explicit m57_system(common::rom_set_image image, m57_board_params board_params = {});
    ...
    [[nodiscard]] std::unique_ptr<m57_system> assemble_m57(common::rom_set_image image,
