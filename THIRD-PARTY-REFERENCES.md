...
- **Irem M62 ROM-set metadata** — declarative manifests under
  ...
  and `ldrun3` now record explicit Z80 program, MC6803 sound ROM, graphics,
  PROM, and timing regions; the remaining M62 sets stay in raw-media staging until their
