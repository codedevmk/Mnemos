...
#   MNEMOS_M58_SET_DIR        path-list of dirs with M58 zips/dirs/wrappers -> irem_m58 manifest load proof
...
$vars = @(
    ...
    @{ Name = "MNEMOS_M58_SET_DIR";      Test = "irem_m58 manifest load proof" },
...
ctest --test-dir $testDir --output-on-failure `
    -R "conformance|c64_basic_boot|sms_boot|genesis_boot|manifest_parity|mnemos_manifests_irem_m(14|15|27|47|52|58|62|63|75|81|82|84|90|92|107)_test|irem_m15_.*golden|irem_m52_.*golden|irem_m72_.*golden|irem_m75_.*golden|irem_m81_.*golden|irem_m82_.*golden|irem_m84_.*golden|irem_m90_.*golden|irem_m92_.*golden|irem_m107_.*golden"
