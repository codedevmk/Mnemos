...
#   MNEMOS_M10_SET_DIR        path-list of dirs with M10/M11 zips/dirs/wrappers -> irem_m10 manifest contract
...
#   MNEMOS_REDALERT_SET_DIR   path-list of dirs with Red Alert/WW III zips/dirs/wrappers -> irem_redalert manifest contract
...
#   MNEMOS_M78_SET_DIR        path-list of dirs with M78 zips/dirs/wrappers -> irem_m78 manifest contract
...
#   MNEMOS_M102_SET_DIR       path-list of dirs with M102 zips/dirs/wrappers -> irem_m102 manifest contract
#   MNEMOS_M107_SET_DIR       path-list of dirs with M107 zips/dirs/wrappers -> irem_m107 manifest/player smoke
#   MNEMOS_M119_SET_DIR       path-list of dirs with M119 zips/dirs/wrappers -> irem_m119 manifest contract
...
$vars = @(
    ...
    @{ Name = "MNEMOS_M10_SET_DIR";      Test = "irem_m10 manifest contract" },
    ...
    @{ Name = "MNEMOS_REDALERT_SET_DIR"; Test = "irem_redalert manifest contract" },
    ...
    @{ Name = "MNEMOS_M78_SET_DIR";      Test = "irem_m78 manifest contract" },
    ...
    @{ Name = "MNEMOS_M102_SET_DIR";     Test = "irem_m102 manifest contract" },
    @{ Name = "MNEMOS_M107_SET_DIR";     Test = "irem_m107 manifest/player smoke" },
    @{ Name = "MNEMOS_M119_SET_DIR";     Test = "irem_m119 manifest contract" },
