...
#   MNEMOS_M27_SET_DIR        path-list of dirs with M27 zips/dirs/wrappers -> irem_m27 manifest load proof
...
#   MNEMOS_M62_SET_DIR        path-list of dirs with M62 zips/dirs/wrappers -> irem_m62 manifest load proof
#   MNEMOS_M63_SET_DIR        path-list of dirs with M63 zips/dirs/wrappers -> irem_m63 manifest load proof
#   MNEMOS_TRAVRUSA_SET_DIR   path-list of dirs with travrusa zips/wrappers -> travrusa manifest load proof
...
$vars = @(
    ...
    @{ Name = "MNEMOS_M27_SET_DIR";      Test = "irem_m27 manifest load proof" },
    ...
    @{ Name = "MNEMOS_M62_SET_DIR";      Test = "irem_m62 manifest load proof" },
    @{ Name = "MNEMOS_M63_SET_DIR";      Test = "irem_m63 manifest load proof" },
    @{ Name = "MNEMOS_TRAVRUSA_SET_DIR"; Test = "irem_travrusa manifest load proof" },
...
ctest --test-dir $testDir --output-on-failure `
    -R "conformance|c64_basic_boot|sms_boot|genesis_boot|manifest_parity|mnemos_manifests_irem_m(14|15|27|47|52|58|62|63|75|81|82|84|90|92|107)_test|mnemos_manifests_irem_travrusa_test|irem_m15_.*golden|irem_m52_.*golden|irem_m58_.*golden|irem_m72_.*golden|irem_m75_.*golden|irem_m81_.*golden|irem_m82_.*golden|irem_m84_.*golden|irem_m90_.*golden|irem_m92_.*golden|irem_m107_.*golden"
