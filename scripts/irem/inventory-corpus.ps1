...
function Test-IgnoredCorpusPath {
    param([Parameter(Mandatory = $true)][string]$Path)
    return $Path -match '(^|[\\/])name-collisions([\\/]|$)'
}
...
function New-ArchiveItem {
    param(
        ...
        [Parameter(Mandatory = $true)][System.Collections.Generic.HashSet[string]]$M78ManifestIds,
        ...
        [Parameter(Mandatory = $true)][System.Collections.Generic.HashSet[string]]$M85ManifestIds,
        ...
        [Parameter(Mandatory = $true)][System.Collections.Generic.HashSet[string]]$M102ManifestIds,
        [Parameter(Mandatory = $true)][System.Collections.Generic.HashSet[string]]$M107ManifestIds,
        [Parameter(Mandatory = $true)][System.Collections.Generic.HashSet[string]]$M119ManifestIds,
        [Parameter(Mandatory = $true)][System.Collections.Generic.HashSet[string]]$TravrusaManifestIds
    )
    ...
    $contractOnly = ($m78Match -or $m102Match -or $m119Match) -and $loadableByMnemos
...
$m78ManifestIds = Read-GameManifestIds "src/manifests/irem_m78/games"
...
$m85ManifestIds = Read-GameManifestIds "src/manifests/irem_m85/games"
...
$m102ManifestIds = Read-GameManifestIds "src/manifests/irem_m102/games"
$m107ManifestIds = Read-GameManifestIds "src/manifests/irem_m107/games"
$m119ManifestIds = Read-GameManifestIds "src/manifests/irem_m119/games"
$travrusaManifestIds = Read-GameManifestIds "src/manifests/irem_travrusa/games"
...
$m78ManifestParents = Read-GameManifestParents "src/manifests/irem_m78/games"
...
$m85ManifestParents = Read-GameManifestParents "src/manifests/irem_m85/games"
...
$m102ManifestParents = Read-GameManifestParents "src/manifests/irem_m102/games"
$m107ManifestParents = Read-GameManifestParents "src/manifests/irem_m107/games"
$m119ManifestParents = Read-GameManifestParents "src/manifests/irem_m119/games"
$travrusaManifestParents = Read-GameManifestParents "src/manifests/irem_travrusa/games"
...
Add-ManifestParents -ManifestIds $m78ManifestIds -ParentMap $m78ManifestParents
...
Add-ManifestParents -ManifestIds $m85ManifestIds -ParentMap $m85ManifestParents
...
Add-ManifestParents -ManifestIds $m102ManifestIds -ParentMap $m102ManifestParents
Add-ManifestParents -ManifestIds $m107ManifestIds -ParentMap $m107ManifestParents
Add-ManifestParents -ManifestIds $m119ManifestIds -ParentMap $m119ManifestParents
Add-ManifestParents -ManifestIds $travrusaManifestIds -ParentMap $travrusaManifestParents
...
foreach ($root in @($roots)) {
    ...
    foreach ($file in Get-ChildItem @fileArgs | Sort-Object FullName) {
        if (Test-IgnoredCorpusPath -Path $file.FullName) {
            continue
        }
    ...
    foreach ($directory in Get-ChildItem @dirArgs | Sort-Object FullName) {
        if (Test-IgnoredCorpusPath -Path $directory.FullName) {
            continue
        }
        $bucket = Get-BucketForPath -RootPath $rootPath -Path $directory.FullName
        $item = New-DirectoryItem -Directory $directory -Bucket $bucket -M14ManifestIds $m14ManifestIds -M15ManifestIds $m15ManifestIds -M27ManifestIds $m27ManifestIds -M47ManifestIds $m47ManifestIds -M52ManifestIds $m52ManifestIds -M57ManifestIds $m57ManifestIds -M58ManifestIds $m58ManifestIds -M62ManifestIds $m62ManifestIds -M63ManifestIds $m63ManifestIds -M72ManifestIds $m72ManifestIds -M75ManifestIds $m75ManifestIds -M78ManifestIds $m78ManifestIds -M81ManifestIds $m81ManifestIds -M82ManifestIds $m82ManifestIds -M84ManifestIds $m84ManifestIds -M85ManifestIds $m85ManifestIds -M90ManifestIds $m90ManifestIds -M92ManifestIds $m92ManifestIds -M102ManifestIds $m102ManifestIds -M107ManifestIds $m107ManifestIds -M119ManifestIds $m119ManifestIds -TravrusaManifestIds $travrusaManifestIds
        if ($null -ne $item) {
            $items.Add($item)
        }
    }
...
$bucketRows = @($items |
    ...
    ForEach-Object {
        ...
        [pscustomobject]@{
            ...
            m78_manifest_matches = @($groupItems | Where-Object { $_.m78_manifest_match }).Count
            ...
            m85_manifest_matches = @($groupItems | Where-Object { $_.m85_manifest_match }).Count
            ...
            m102_manifest_matches = @($groupItems | Where-Object { $_.m102_manifest_match }).Count
            m107_manifest_matches = @($groupItems | Where-Object { $_.m107_manifest_match }).Count
            m119_manifest_matches = @($groupItems | Where-Object { $_.m119_manifest_match }).Count
            travrusa_manifest_matches = @($groupItems | Where-Object { $_.travrusa_manifest_match }).Count
...
$report = [pscustomobject]@{
    ...
    summary = [pscustomobject]@{
        ...
        m78_manifest_matches = @($items | Where-Object { $_.m78_manifest_match }).Count
        ...
        m85_manifest_matches = @($items | Where-Object { $_.m85_manifest_match }).Count
        ...
        m102_manifest_matches = @($items | Where-Object { $_.m102_manifest_match }).Count
        m107_manifest_matches = @($items | Where-Object { $_.m107_manifest_match }).Count
        m119_manifest_matches = @($items | Where-Object { $_.m119_manifest_match }).Count
        travrusa_manifest_matches = @($items | Where-Object { $_.travrusa_manifest_match }).Count
        ...
        irem_split_clone_contract_item_count = @($items | Where-Object { $_.corpus_classification -eq "irem_split_clone_contract" }).Count
