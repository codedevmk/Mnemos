...
Set-EnvIfPathExists -Name "MNEMOS_REDALERT_SET_DIR" -Path (Join-CorpusPath -Base $rootPath -Child "M27")
...
Set-EnvIfPathExists -Name "MNEMOS_M102_SET_DIR" -Path (Join-CorpusPath -Base $rootPath -Child "M102")
