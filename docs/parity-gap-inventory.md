...
YM2151 Timer A IRQ path through V35 INTP0/vector-24, the shared Fire Barrel / Air
Assault SW1/SW2 DIP
profile default (`0xffbf`), and the separate SW3 `COINS_DSW3` default
(`0xebff`). The M107 adapter also maps frontend service/test input onto the
