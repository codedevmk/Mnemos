...
routes. `ldrun` has an explicit CPU/sound/video/PROM region contract, while the
remaining M62 sets stay as raw-media staging routes; the three `.7z` M62 matches
