...
save-state persistence, and the shared Fire Barrel / Air Assault SW1/SW2 DIP
profile default (`0xffbf`). Root and `m72`-folder duplicates are also visible as
M107 artifacts; the two Fire Barrel `.7z` copies remain metadata-only until
