...
- [x] Implement `foundation::bits` (popcount, clz, byte order, bitfield helpers). (this commit: Claude review completed; windows-msvc-debug configure/build/test green)
