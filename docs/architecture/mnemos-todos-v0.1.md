...
- [x] Unit tests for every module above with ≥ 90 % branch coverage. (1d20324; CI run 26280879101 green across clang-format, foundation coverage, and all 6 build/test jobs)
