...
not yet map it to a numbered M-board. Of those 437 items, 291 currently match a
checked-in Mnemos Irem manifest, 158 are readable through the current ZIP,
single-inner wrapper ZIP, or unpacked-folder media routes, and 158 have an
...
| M92 | `irem_m92` | 55% first-pass | `bmaster`, `crossbld`, `geostorm`, `gunforce`, `gunforcej`, `gunforceu`, `gunforc2`, `gunhohki`, `hook`, `inthunt`, `inthuntu`, `lethalth`, `majtitl2`, `majtitl2a`, `majtitl2b`, `majtitl2j`, `mysticri`, `mysticrib`, `nbbatman`, `nbbatmanu`, `rtypeleo`, `rtypeleoj`, `thndblst`, `uccops`, `uccopsar`, `uccopsj`, `uccopsu` | all 27 data-gated first-pass sets; Blade Master Japan, Geostorm, In the Hunt US, GunForce, Lethal Thunder/Thunder Blaster, Major Title 2, Mystic Riders, Ninja Baseball Bat Man, R-Type Leo, and Undercover Cops nonblank/save-state smokes; modeled V35 command/YM IRQ priority proof | None | Encrypted V35 sound CPU behavior/decryption, GA21/GA22 video/priority, exact M92 memory/I/O, protection, DIP/raster/audio/video parity |
...
- **Mnemos games:** `bmaster`, `crossbld`, `geostorm`, `gunforce`,
  ...
  `inthuntu`, `lethalth`, `majtitl2`, `majtitl2a`, `majtitl2b`, `majtitl2j`,
  `mysticri`, `mysticrib`, `nbbatman`, `nbbatmanu`, `rtypeleo`, `rtypeleoj`,
  `thndblst`, `uccops`, `uccopsar`, `uccopsj`, and `uccopsu`
  as checked-in manifests under `irem_m92`.
- **Smoke playable:** all twenty-seven checked-in M92 manifests load through
  ...
  `majtitl2j.zip` have direct save-state proof.
...
- **Local corpus note:** the current `D:\emu\irem\M92` bucket has 65 tracked
  M92 manifest-name matches, 28 direct player-loadable/supported ZIP routes,
  and 37 metadata-only routes, including `.7z` archives and artwork/layout
  packages. Twenty-seven checked-in M92-era set IDs now resolve to embedded
  ...
  `majtitl2b`, `majtitl2j`) via parent fallback, the Mystic Riders split bootleg route
