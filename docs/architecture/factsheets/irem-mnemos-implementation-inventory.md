...
| M107 | `irem_m107` | 53% | `airass`, `firebarr` | both data-gated; Air Assault direct nonblank/save-load; shared SW1/SW2 DIP default `0xffbf`; SW3 `COINS_DSW3` default `0xebff`; service/test input proof | None | V33/V35-specific behavior, deeper M107 I/O proof, GA21/GA22 video, command IRQ/GA20 analog mix, raster/parity |
...
- **Remaining:** V33/V35-specific timing and on-die peripheral proof, deeper
  M107 I/O behavior, GA21/GA22 video and priority behavior, command IRQ timing,
  GA20 analog mix, raster timing, and screenshot/audio parity.
